...
void _defineTestSuites() {
  ...
  void rust(String name, Map<String, String> tests) {
    var executable =
        name == "rlox" ? "target/debug/rlox" : "target/debug/$name";
    _allSuites[name] = Suite(name, "rust", executable, [], tests);
    _rustSuites.add(name);
  }
  ...
  rust("rlox", {
    "test": "skip",
    "test/empty_file.lox": "pass",
    "test/precedence.lox": "pass",
  });
}
